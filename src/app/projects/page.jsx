...
const Projects = () => {
  return (
    <main className="max-w-screen-lg mx-auto mt-24 p-5">
      <div>
        <h1 className="animate__animated animate__fadeInUp animate__faster text-emerald-300 text-5xl font-bold [text-shadow:1px_1px_100px_var(--tw-shadow-color)] shadow-blue-500">
          Projects<span className="text-emerald-300">.</span>
        </h1>
        <p className="text-zinc-400 animate__animated animate__fadeInUp animate__fast mt-5">Showcase of my works.</p>
      </div>
      <div className="md:grid md:grid-cols-3 gap-10 mt-10">
        ...
        <ProjectsCard title="Dashboard Monitoring Melon" desc="This website is created to monitoring and controlling the growth and development of melon fruits." repo={'https://github.com/niemoo/dashboard-melon'} />
