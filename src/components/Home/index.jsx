  ...
  return (
    <div>
      <section className="flex justify-between items-center">
        ...
        <Image src={Izzan} width={100} height={100} alt="" />
      </section>
      <section className="mt-10">
        <p className="text-zinc-400 animate__animated animate__fadeInUp animate__fast">I'm a web developer based in Jakarta, Indonesia. Experienced with Web Development </p>
        <p className="text-zinc-400 animate__animated animate__fadeInUp animate__fast">using Node JS, Express JS, React JS, and Next JS technology.</p>
      </section>
